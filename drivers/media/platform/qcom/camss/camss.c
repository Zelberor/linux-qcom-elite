...
static const struct camss_subdev_resources csiphy_res_kaanapali[] = {
	...
	{
		.regulators = {
			// TODO: find init_load_uA values
			{ .supply = "vdda-phy0", .init_load_uA = 0 },
	...
	/* CSIPHY1 */
	{
		.regulators = {
			// TODO: find init_load_uA values
			{ .supply = "vdda-phy1", .init_load_uA = 0 },
			{ .supply = "vdda-pll", .init_load_uA = 0 },
		},
	...
	/* CSIPHY2 */
	{
		.regulators = {
			// TODO: find init_load_uA values
			{ .supply = "vdda-phy2", .init_load_uA = 0 },
			{ .supply = "vdda-pll", .init_load_uA = 0 },
		},
	...
	/* CSIPHY3 */
	{
		.regulators = {
			// TODO: find init_load_uA values
			{ .supply = "vdda-phy3", .init_load_uA = 0 },
			{ .supply = "vdda-pll", .init_load_uA = 0 },
		},
	...
	/* CSIPHY4 */
	{
		.regulators = {
			// TODO: find init_load_uA values
			{ .supply = "vdda-phy4", .init_load_uA = 0 },
			{ .supply = "vdda-pll", .init_load_uA = 0 },
		},
	...
	/* CSIPHY5 */
	{
		.regulators = {
			// TODO: find init_load_uA values
			{ .supply = "vdda-phy5", .init_load_uA = 0 },
			{ .supply = "vdda-pll", .init_load_uA = 0 },
		},
